package com.example.ass7_603020771_3
...
class MainActivity : AppCompatActivity() {
    ...
    fun testEmployeeData() {
        EmployeeList.add(Employee("Chanathip", "Female","oiw_chana@gmail.com",50000))
        EmployeeList.add(Employee("Chadaporn", "Female","pang@gmail.com",45000))
    }
}